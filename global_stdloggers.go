...
func newNLoggerInstance(tagName string, fields ...zap.Field) *StdLogger {
	...
	stdCore := zapcore.NewCore(encoder, writer, newTrackLevelEnabler(Setting.LogLevel, Setting.EnableTracLevel)).With(append([]zap.Field{zap.String(Tags, tagName)}, fields...))
